...
namespace com.liteninja.tweens
{
    public static class Vector2TweenExtensions
    {
        public static async Task Tween(this Vector2 vector,  Vector2 to,
            float time, Tween.EaseFunc easeFunc, Action completeAction = null, CancellationToken cancellationToken = default)
        {
            var from = vector;
            var tween = new Tween();
        ...
        public static async Task TweenPosition(this Vector2 vector,  Vector2 to,
            float time, AnimationCurve animationCurve, Action completeAction = null, CancellationToken cancellationToken = default)
        {
